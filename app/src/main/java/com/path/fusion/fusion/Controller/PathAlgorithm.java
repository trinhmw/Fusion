...
/**
 * Created by Melissa on 3/3/2015.
 */
public class PathAlgorithm {
    ...
    public PathAlgorithm() {
        this.nodes = generateVertex(fileManager.getUnique());
        this.edges = fileManager.getEdges();
    }
    ...
    private List<Vertex> generateVertex(ArrayList<String> unique){
        List<Vertex> vertexList = new ArrayList<Vertex>();
        for(String item : unique){
            vertexList.add(new Vertex(item, item));
        }
        return vertexList;
    }
